    ...
    <div class="modal-container bg-slate-900 w-11/12 md:max-w-md mx-auto shadow-lg z-50 overflow-y-auto text-[#1A988A] rounded-lg">
        ...
        <div class="modal-content py-4 text-left px-6">
            <div class="flex justify-end">
                ...
                <form method="POST" action="{{ Route('start-treatment') }}">
                    @csrf
                    <div class="">
                        <label for="sickness_id" class="text-lg font-bold block text-gray-300">Sickness</label>
                        <select type="text" name="sickness_id" placeholder="select Sickness" class="w-full rounded-lg bg-slate-500 text-gray-200" max-size="1" required >
                    ...
                    <div class="">
                        ...
                        <select type="text" name="doctor_id" placeholder="select doctor" class="w-full rounded-lg bg-slate-500 text-gray-200" required >
                    ...
                    <div class="">
                        ...
                        <input type="date" name="start_date" value="{{ date('Y-m-d') }}"class="w-full rounded-lg bg-slate-500 text-gray-200"/>
                    </div>
