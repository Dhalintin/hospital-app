	...
	<div x-data="app()" x-cloak>
		<div class="max-w-3xl mx-auto px-4 py-10">
			...
			<div x-show.transition="step === 'complete'">
				<div class="rounded-lg p-10 flex text-center shadow justify-between">
					<div>
				...
				<div class="border-b-2 py-4">
					...
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						<div class="flex-1">
							...
							<div x-show="step === 2">
								<div class="text-lg font-bold text-gray-700 leading-tight">Contact Info</div>
							</div>
				...
				<div class="py-10">	
					...
					<div x-show.transition.in="step === 3">
						...
						<div class="mb-5">
                            ...
                            <div class="mb-5">
                                <label for="phone" class="font-bold mb-1 text-gray-700 block">Phone Number</label>
					...
					<div x-show.transition.in="step === 2">
                        <div class="mb-5">
                            ...
                            <input type="date" name="dob"
                                class="w-full px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" max="{{ date('Y-m-d') }}">
                        </div>
				...
				<div class="flex justify-between">
					...
					<div class="w-2/2 text-right">
						<button
							x-show="step < 3"
							@click="step++"
							class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-center float-end text-white bg-blue-500 hover:bg-blue-600 font-medium" 
						>Next</button>

						<button
							@click="step = 'complete'"
							x-show="step === 3"
							class="w-32 focus:outline-none border border-transparent py-2 px-5 rounded-lg shadow-sm text-white bg-blue-500 hover:bg-blue-600 font-medium" 
						>Complete</button>
					</div>
				</div>
			</div>
